...
vec3 ones={1,1,1}, vecop_buffer[99], point,
  closest_point, objpoint_or_material, normal, pix_color,
...
real twothirds=.66, closest_dist_squared, text_width=0,
  angle_or_width, raydist_or_brightness,
